...
package org.codehaus.plj.methodfinder.impl;
...
import org.codehaus.plj.methodfinder.MethodFinder;
 ...
 * @avalon.service type="org.codehaus.plj.methodfinder.MethodFinder"
 * 
 * @dna.component
 * @dna.service type="org.codehaus.plj.methodfinder.MethodFinder"
 * 
...
public class DefaultMethodFinder
	...
	/* (non-Javadoc)
	 * @see org.codehaus.plj.methodfinder.MethodFinder#findMethod(org.codehaus.plj.messages.AbstractCall, java.lang.Class)
	 */
	...
	protected Method findJSProcMethod(CallRequest call, Class clazz)
		...
		org.codehaus.plj.typemapping.Field[] params = new org.codehaus.plj.typemapping.Field[paramvector
				.size()];
		Class[] paramclasses = new Class[params.length];

		for (int i = 0; i < params.length; i++) {
			params[i] = (org.codehaus.plj.typemapping.Field) paramvector.get(i);
	...
	/* (non-Javadoc)
	 * @see org.codehaus.plj.methodfinder.MethodFinder#createParameters(org.codehaus.plj.messages.AbstractCall, java.lang.reflect.Method)
	 */
	 ...
	 * 
	 * @avalon.dependency key="tuple-mapper" type="org.codehaus.plj.tuplemapper.TupleMapper"
	 * 
	 * 
	 * @dna.dependency key="tuple-mapper" type="org.codehaus.plj.tuplemapper.TupleMapper"
	 * 
	 */
