...
package org.codehaus.plj.tuplemapper.impl.reflected;
...
public class ReflectedTupleMapper
	...
	public Object mapTuple(Tuple tuple) throws MappingException {
		try {
			...
			while (it.hasNext()) {
				...
				org.codehaus.plj.typemapping.Field fld = (Field) fldMap.get(fldName);
	 ...
	 * 
	 * @avalon.dependency key="classloader" type="org.codehaus.plj.classloaders.PLJClassLoader"
	 * 
	 * @dna.dependency key="classloader" type="org.codehaus.plj.classloaders.PLJClassLoader"
	 */
